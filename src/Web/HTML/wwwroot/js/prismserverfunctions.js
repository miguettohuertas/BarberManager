...
function TPrismDatasnapFunctions(connectionInfo)
{
  this.executor = new ServerFunctionExecutor("TPrismDatasnapFunctions",connectionInfo);
  ...
  /*
   * @param UUID [in] - Type on server: string
   * @param Token [in] - Type on server: string
   * @param FormUUID [in] - Type on server: string
   * @param ID [in] - Type on server: string
   * @param EventID [in] - Type on server: string
   * @param Parameters [in] - Type on server: string
   */
  this.ExecEvent = function(UUID, Token, FormUUID, ID, EventID, Parameters) {
    this.executor.executeMethod('ExecEvent', "GET", [UUID, Token, FormUUID, ID, EventID, Parameters], arguments[6], false, arguments[7], arguments[8]);
  };

  this.ExecEvent_URL = function(UUID, Token, FormUUID, ID, EventID, Parameters) {
    return this.executor.getMethodURL("ExecEvent", "GET", [UUID, Token, FormUUID, ID, EventID, Parameters], arguments[6])[0];
  };
   ...
   * @return result - Type on server: string
   */
  this.GetFromEvent = function(UUID, Token, FormUUID, ID, EventID, Parameters) {
    var returnObject = this.executor.executeMethod('GetFromEvent', "GET", [UUID, Token, FormUUID, ID, EventID, Parameters], arguments[6], true, arguments[7], arguments[8]);
    if (arguments[6] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        ...
        resultObject.FormUUID = FormUUID;
        resultObject.ID = ID;
  ...
  this.GetFromEvent_URL = function(UUID, Token, FormUUID, ID, EventID, Parameters) {
    return this.executor.getMethodURL("GetFromEvent", "GET", [UUID, Token, FormUUID, ID, EventID, Parameters], arguments[6])[0];
  };
   ...
   * @return result - Type on server: string
   */
  this.CallBack = function(UUID, Token, FormUUID, CallBackID, Parameters) {
    var returnObject = this.executor.executeMethod('CallBack', "GET", [UUID, Token, FormUUID, CallBackID, Parameters], arguments[5], true, arguments[6], arguments[7]);
    if (arguments[5] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.CallBack_URL = function(UUID, Token, FormUUID, CallBackID, Parameters) {
    return this.executor.getMethodURL("CallBack", "GET", [UUID, Token, FormUUID, CallBackID, Parameters], arguments[5])[0];
  };
   ...
   * @param Token [in] - Type on server: string
   * @param FormUUID [in] - Type on server: string
   * @param Content [in] - Type on server: TStringStream
   */
  this.SaveEnvironment = function(UUID, Token, FormUUID, Content) {
    this.executor.executeMethod('"SaveEnvironment"', "POST", [UUID, Token, FormUUID, Content], arguments[4], false, arguments[5], arguments[6]);
  };
   ...
   * @return result - Type on server: string
   */
  this.LoadEnvironment = function(UUID, Token, FormUUID) {
    var returnObject = this.executor.executeMethod('LoadEnvironment', "GET", [UUID, Token, FormUUID], arguments[3], true, arguments[4], arguments[5]);
    if (arguments[3] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.LoadEnvironment_URL = function(UUID, Token, FormUUID) {
    return this.executor.getMethodURL("LoadEnvironment", "GET", [UUID, Token, FormUUID], arguments[3])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TPrismDatasnapFunctions": ["ReverseString","ExecEvent","GetFromEvent","CallBack","SaveEnvironment","LoadEnvironment"]
};
